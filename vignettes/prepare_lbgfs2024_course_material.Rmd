...
# slides qmd
SLIPATH=inst/website/lbgfs2024/slides/slides.qmd
echo '---' > $SLIPATH
echo 'title: "Slides"' >> $SLIPATH
echo '---' >> $SLIPATH
echo >> $SLIPATH
echo >> $SLIPATH
echo '```{r}' >> $SLIPATH
echo '#| echo: false' >> $SLIPATH
echo '#| results: asis' >> $SLIPATH
echo 'if (is.element("rmdhelp", installed.packages()))' >> $SLIPATH
echo '  cat(paste0(rmdhelp::get_latest_change()))' >> $SLIPATH
echo '```' >> $SLIPATH
echo >> $SLIPATH

# table data
echo 'Date;Text;Filename' > inst/website/lbgfs2024/slides/slides.dat
echo '2024-09-20;Introduction;l01_intro_lbg.pdf' >> inst/website/lbgfs2024/slides/slides.dat
