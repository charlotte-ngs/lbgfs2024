...
## Linearity of Breeding Values

```{r linearity-breeding-values, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width="100%"}
#rmdhelp::use_odg_graphic(ps_path = "odg/linearity-breeding-values.odg", ps_odg_template = "odg_draw_a4_landscape")
knitr::include_graphics(path = "odg/linearity-breeding-values.png")
```
...
## Breeding Values of Parents and Offspring

Breeding value of parent $d$ meansures value of alleles passed to offspring $o$

```{r bv-parent-offspring, echo=FALSE, hook_convert_odg=TRUE, fig_path="odg", out.width="100%"}
#rmdhelp::use_odg_graphic(ps_path = "odg/bv-parent-offspring.odg")
knitr::include_graphics(path = "odg/bv-parent-offspring.png")
```




## Breeding Values of Parents and Offspring II

* Alternative notation

$$BV_{o} = a * BV_{s} + b * BV_{d} + m_o$$

* Part of alleles from parent to offspring: $50%$

$\rightarrow$ Regression factors $a = b = 0.5$ and $m_o$ is a random residual quantity with 

* expected value $E(m_o) = 0$ and 
* variance $var(m_o) = \sigma_m^2$
